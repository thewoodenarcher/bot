...
async def truefalse(ctx, arg):
    embed = discord.Embed(title=arg "is").set_image(url=random.choice(["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQ3ES91tsQruRJGK-xLIq7LkjH66RSQyXTG4vCBenuF1UBtT61", "http://www.shatec.sg/wp-content/uploads/2017/05/baking-beliefs-debunked-true-495x207.png"])
